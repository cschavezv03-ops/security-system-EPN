...
| 4 | Distinguir bloqueo, baja y contraseña incorrecta | Estado consultado antes de Auth, función sin JWT y fallo de consulta no confundido con credenciales. | `supabase.test.ts` |
...
| 7 | Administrativo solo puede elegir EPN | Catálogo dependiente de categoría, sin descripción bajo Unidad, y trigger de respaldo. | `ResourceScreen.test.tsx` + migración `20260722120000` |
